...
public class Inventory {
    ...
    public int getSedan() {
        return Sedan; }
    public void setSedan(int _Sedan) {
        this.Sedan = _Sedan; }
    ...
    public int getVans() {
        return Vans; }
    public void setVans(int _Vans) {
        this.Vans = _Vans; }

    //Setter and Getter for Hybrid
    public int getHybrid() {
        return Hybrid; }
    public void setHybrid(int _Hybrid) {
        this.Hybrid = _Hybrid; }
    ...
    public int getSparkPlugs() {
        return SparkPlugs; }
    public void setSparkPlugs(int _SparkPlugs) {
        this.SparkPlugs = _SparkPlugs; }

    //Setter and Getter for Valves
    public int getValves() {
        return Valves; }
    public void setValves(int _Valves) {
        this.Valves = _Valves; }

    //Setter and Getter for Inquiries
    public int getPistons() {
        return Pistons; }
    public void setPistons(int _Pistons) {
        this.Pistons = _Pistons; }

    //Setter and Getter for PistonRings
    public int getPistonRings() {
        return PistonRings; }
    public void setPistonRings(int _PistonRings) {
        this.PistonRings = _PistonRings; }

    //Setter and Getter for ContactInformation
    public int getConnectingRods() {
        return ConnectingRods; }
    public void setConnectingRods(int _ConnectingRods) {
        this.ConnectingRods = _ConnectingRods; }

    //--Accessories--//
    //Setter and Getter for Interior
    public int getInterior() {
        return Interior; }
    public void setInterior(int _Interior) {
        this.Interior = _Interior; }

    //Setter and Getter for Exterior
    public int getExterior() {
        return Exterior; }
    public void setExterior(int _Exterior) {
        this.Exterior = _Exterior; }

    //Setter and Getter for Lighting
    public int getLighting() {
        return Lighting; }
    public void setLighting(int _Lighting) {
        this.Lighting = _Lighting; }

    //Setter and Getter for Towing
    public int getTowing() {
        return Towing; }
    public void setTowing(int _Towing) {
        this.Towing = _Towing; }

    //--Batteries--//
    //Setter and Getter for Duralast
    public int getDuralast() {
        return Duralast; }
    public void setDuralast(int _Duralast) {
        this.Duralast = _Duralast; }

    //Setter and Getter for Odyssey
    public int getOdyssey() {
        return Odyssey; }
    public void setOdyssey(int _Odyssey) {
        this.Odyssey = _Odyssey; }

    //Setter and Getter for Optima
    public int getOptima() {
        return Optima; }
    public void setOptima(int _Optima) {
        this.Optima = _Optima; }
    ...
    public int getGoodyear() {
        return Goodyear; }
    public void setGoodyear(int _Goodyear) {
        this.Goodyear = _Goodyear; }

    //Setter and Getter for Firesone
    public int getFiresone() {
        return Firesone; }
    public void setFiresone(int _Firesone) {
        this.Firesone = _Firesone; }

    //Setter and Getter for Bridgesone
    public int getBridgesone() {
        return Bridgesone; }
    public void setBridgesone(int _Bridgesone) {
        this.Bridgesone = _Bridgesone; }

    //Setter and Getter for Michelin
    public int getMichelin() {
        return Michelin; }
    public void setMichelin(int _Michelin) {
        this.Michelin = _Michelin; }

    //--Brakes--//
    //Setter and Getter for Pads
    public int getPads() {
        return Pads; }
    public void setPads(int _Pads) {
        this.Pads = _Pads; }

    //Setter and Getter for RotorsCalipers
    public int getRotorsCalipers() {
        return RotorsCalipers; }
    public void setRotorsCalipers(int _RotorsCalipers) {
        this.RotorsCalipers = _RotorsCalipers; }
